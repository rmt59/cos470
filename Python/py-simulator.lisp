;; [[file:python-simulator.org::*Module setup][Module setup:2]]
...
;; [[file:python-simulator.org::*Global variables][Global variables:1]]
...
;; [[file:python-simulator.org::*Classes][Classes:1]]
(defclass simulator ()
  (
...
;; [[file:python-simulator.org::*Simulator methods][Simulator methods:1]]
...
;; [[file:python-simulator.org::*Simulator methods][Simulator methods:2]]
...
;; [[file:python-simulator.org::*Sensor methods][Sensor methods:1]]
...
;; [[file:python-simulator.org::*Effector (actuator) methods][Effector (actuator) methods:1]]
...
;; [[file:python-simulator.org::*World methods][World methods:1]]
...
;; [[file:python-simulator.org::*Object methods][Object methods:1]]
...
;; [[file:python-simulator.org::*Robot methods][Robot methods:1]]
...
;; [[file:python-simulator.org::*Example: =random-robot=][Example: =random-robot=:1]]
